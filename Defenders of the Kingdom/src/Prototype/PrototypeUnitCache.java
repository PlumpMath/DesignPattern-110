...
public class PrototypeUnitCache {
   ...
   public static    HashMap<String,Weapons>fetchWeapons(String unit,String weaponname){
	  ...
	  if(lstweapon.isEmpty()||!lstweapon.containsKey(unit)){
	...
	if(weaponname == "Spear")
		lstweapon.put(unit,new Spear(weapon,unit+"Spear"));
	...
	if(weaponname == "Arrow")
	  ...
	  if(lstweapon.containsKey(unit)){
			if(weaponname == "Sword")
		  lstweapon.put(unit,new Sword(lstweapon.get(unit),unit+"sword"));
			if(weaponname == "Spear")
				  lstweapon.put(unit,new Sword(lstweapon.get(unit),unit+"spear"));	
			if(weaponname == "Bow")
				 lstweapon.put(unit,new Sword(lstweapon.get(unit),unit+"Bow"));
			if(weaponname == "Arrow")
				lstweapon.put(unit,new Arrow(weapon,unit+"Bow"));	
	  }
